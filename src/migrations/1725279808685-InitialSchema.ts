...
export class InitialSchema1725279808685 implements MigrationInterface {
    name = 'InitialSchema1725279808685'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`album\` (\`id\` varchar(36) NOT NULL, \`name\` varchar(255) NOT NULL, \`year\` int NOT NULL, \`artistId\` varchar(255) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`artist\` (\`id\` varchar(36) NOT NULL, \`name\` varchar(255) NOT NULL, \`userId\` varchar(255) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
